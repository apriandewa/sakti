    ...
    public function calculatePerformance(int $bulan, int $tahun, string $nama, string $nip): array
    {
        ...
        return [
            ...
            'presensi' => [
                ...
                'count_tl1'         => (int) ($rekapPresensi['tl1'] ?? 0),
                'count_tl2'         => (int) ($rekapPresensi['tl2'] ?? 0),
                'count_tl3'         => (int) ($rekapPresensi['tl3'] ?? 0),
                'count_tl4'         => (int) ($rekapPresensi['tl4'] ?? 0),
                'count_psw1'        => (int) ($rekapPresensi['psw1'] ?? 0),
                'count_psw2'        => (int) ($rekapPresensi['psw2'] ?? 0),
                'count_psw3'        => (int) ($rekapPresensi['psw3'] ?? 0),
                'count_psw4'        => (int) ($rekapPresensi['psw4'] ?? 0),
