...
class File extends Model
{
    ...
    protected $appends =[
      'link_stream','link_download','link_delete','public_stream'
    ];
    ...
    public function getPublicStreamAttribute(): string
    {
        return url(config('master.app.url.frontend') . "/file/stream/{$this->id}/{$this->name_alias}-" . uniqid());
    }
