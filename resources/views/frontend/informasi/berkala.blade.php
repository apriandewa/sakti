        ...
        <div class="row mb-4" data-aos="fade-up">
          <div class="col-12">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 p-3 rounded-3"
              ...
              @if(request('search'))
                <a href="{{ route('informasi.berkala') }}" class="btn btn-sm btn-outline-secondary">
          ...
          <div class="col-12">
            <div class="alert alert-warning text-center py-4">
              ...
              @if(request('search'))
                ...
                <br><a href="{{ route('informasi.berkala') }}" class="btn btn-sm btn-outline-secondary mt-2">
