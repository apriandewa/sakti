  ...
  <section id="services" class="services section">
    ...
    <div class="container section-title text-center" data-aos="fade-up">
      ...
      <div class="col-lg-5 col-12 mx-auto">
        ...
        <form action="{{ route('informasi.sertamerta') }}" method="get"
          ...
          <div class="input-group">
            <input
              ...
              class="form-control"
              id="search"
              placeholder="Cari Informasi Serta Merta Disini ..."
              aria-label="Search"
        ...
        <div class="row mb-4" data-aos="fade-up">
          <div class="col-12">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 p-3 rounded-3"
              ...
              @if(request('search'))
                <a href="{{ route('informasi.sertamerta') }}" class="btn btn-sm btn-outline-secondary">
      ...
      <div class="row gy-4">
        ...
        @if($apiData->count() > 0)
          ...
          @foreach($apiData as $item)
            @php
              $tipe      = $item['tipe_label'] ?? 'SERTA MERTA';
              $badgeClass = match(strtoupper($tipe)) {
                  'BERKALA'      => 'bg-success',
                  'TERSEDIA'     => 'bg-primary',
                  'SETIAP SAAT'  => 'bg-info text-dark',
                  'SERTA MERTA'  => 'bg-info text-dark', // Added mapping to info
              ...
              $icon = match(strtoupper($tipe)) {
                  ...
                  'SERTA MERTA'  => 'bi-clock-history', // Added mapping to icon
          ...
          <div class="col-12">
            <div class="alert alert-warning text-center py-4">
              ...
              @if(request('search'))
                ...
                <br><a href="{{ route('informasi.sertamerta') }}" class="btn btn-sm btn-outline-secondary mt-2">
