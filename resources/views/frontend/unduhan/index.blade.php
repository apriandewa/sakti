                ...
                <article>
                    <div class="post-img">
                      ...
                      <span class="post-category">
                              ...
                              <a href="{{ url('unduhan') }}?kategori={{ $slugKategori }}">
                    ...
                    <h2 class="title">
                      <a href="{{ route('unduhan.detail', $news->slug) }}">{{$news->nama}}</a>
                    </h2>
                    ...
                    <div class="content">
                      <div class="read-more">
                        <a href="{{ route('unduhan.detail', $news->slug) }}">Selengkapnya <i class="bi bi-arrow-right"></i></a> 
                      </div>
                    </div>
                </article>
            </div>
