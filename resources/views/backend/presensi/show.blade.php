<div class="modal-header">
    <h4 class="modal-title" id="modal-title-label">
        <i class="fa fa-calendar-check-o text-info me-10"></i> Log Kehadiran Harian Pegawai
    </h4>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-12 col-sm-7 d-flex flex-column justify-content-center">
                        <div class="p-15">
                            ...
                            <p class="text-muted mb-15 font-size-13"><i class="fa fa-building text-info me-5"></i> {{ $pegawai->nama_kantor ?? '-' }}</p>
                            ...
                            <div class="row text-center mb-2">
                                ...
                                <div class="col-4 mb-2">
                                    <div class="bg-primary-light p-10 rounded border border-primary border-opacity-25 transition-hover">
                                        <h6 class="text-primary mb-5 font-weight-bold font-size-13">Dinas Luar</h6>
                    ...
                    <div class="d-flex flex-column align-items-center justify-content-center py-10">
                        <svg viewBox="0 0 36 36" class="circular-chart" id="attendance-donut">
                            ...
                            <path class="donut-segment color-dl"
                                data-label="Dinas Luar" data-val="{{ $countDl }} Hari" data-color="#0d6efd"
            ...
            <tbody>
                @forelse($logs as $index => $log)
                    <tr>
                        ...
                        <td class="text-center font-weight-bold" style="white-space: nowrap;">{{ \Carbon\Carbon::parse($log->tanggal)->translatedFormat('l, d F Y') }}</td>
                        <td class="text-center">
                            <span class="badge {{ $log->badge_class }} font-weight-bold">{{ $log->status_kehadiran ?? '-' }}</span>
                        </td>
