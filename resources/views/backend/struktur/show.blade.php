        ...
        <div class="row">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					{!! html()->p($data->jabatan)->class("form-control") !!}
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
					{!! html()->span()->text("Tugas")->class("control-label") !!}
					{!! html()->p($data->tugas)->class("form-control") !!}
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
			...
			<div class="col-md-6">
				...
				@if(!is_null($data->getfilebyalias('gambar_struktur')))
					@php
						$file = $data->getfilebyalias('gambar_struktur');
					@endphp
					@if($file)
