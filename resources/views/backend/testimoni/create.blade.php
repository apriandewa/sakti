...
<div class="panel shadow-sm">
    <div class="panel-body">
        <div class='form-group'>
			...
			{!! html()->text('nama',NULL)->placeholder('Masukkan Nama')->class('form-control')->id('nama') !!}
		</div>
        <div class='form-group'>
			{!! html()->label()->class('control-label')->for('keterangan')->text('Jabatan') !!}
			{!! html()->text('keterangan',NULL)->placeholder('Masukkan Jabatan')->class('form-control')->id('keterangan') !!}
		</div>
		<div class='form-group'>
			{!! html()->label()->class('control-label')->for('desc')->text('Testimoni') !!}
