...
<div class="panel shadow-sm">
    <div class="panel-body">
        <div class="form-group">
            {!! html()->label('Nama Status','nama')->class('control-label') !!}
            <span class="text-danger">*</span>
            {!! html()->text('nama', $data->nama)->placeholder('Contoh: PNS, PPPK, Honorer')->class('form-control')->id('nama')->required() !!}
        </div>
        <div class="form-group">
            {!! html()->label('Deskripsi','desc')->class('control-label') !!}
            {!! html()->textarea('desc', $data->desc)->placeholder('Ketik deskripsi status di sini')->class('form-control')->id('desc') !!}
        </div>
        <div class="form-group">
