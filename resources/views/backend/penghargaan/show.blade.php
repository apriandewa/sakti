<div class="panel shadow-sm">
    <div class="panel-body">
        <div class="row">
			...
			<div class="col-md-6">
				<div class="form-group">
					{!! html()->span()->text("Penyelenggara")->class("control-label") !!}
					{!! html()->p($data->penyelenggara)->class("form-control") !!}
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
			...
			<div class="col-md-6">
				...
				@if(!is_null($data->getfilebyalias('gambar_penghargaan')))
					@php
						$file = $data->getfilebyalias('gambar_penghargaan');
					@endphp
					@if($file)
